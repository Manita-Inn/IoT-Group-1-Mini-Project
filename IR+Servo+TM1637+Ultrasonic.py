        ...
        if dist > 0 and dist < DETECT_CM:
            ...
            if available > 0:
                ...
                if not gate_open:
                    ...
                    print("Vehicle detected — Gate OPEN")
                ...
                if not full_notified:
                    ...
                    print("Parking FULL — vehicle denied")
            ...
            if gate_open and last_detect_time is not None:
                ...
                remaining = AUTO_CLOSE_SEC - elapsed

                if remaining > 0:

                    print("No vehicle — closing in {:.1f}s".format(remaining))
